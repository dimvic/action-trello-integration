...
var require_input = __commonJS({
  "src/input.js"(exports, module2) {
    var core2 = require_core();
    module2.exports = {
      GITHUB_TOKEN: core2.getInput("github-token", { required: true }),
      TRELLO_API_KEY: core2.getInput("trello-api-key", { required: true }),
      TRELLO_TOKEN: core2.getInput("trello-token", { required: true }),
      TRELLO_BOARD_ID: core2.getInput("trello-board-id", { required: true }),
      PR_ENFORCE_CARD_EXISTS: core2.getInput("pr-enforce-card-exists", { required: false }) !== "false",
      ...
      PR_CARD_CODE_REGEXP: core2.getInput("pr-card-code-regexp", { required: false }),
      PR_SKIP_BASE_REF_REGEXP: core2.getInput("pr-skip-base-ref-regexp", { required: false }),
      PR_SKIP_HEAD_REF_REGEXP: core2.getInput("pr-skip-head-ref-regexp", { required: false }),
      PR_SKIP_USER_REGEXP: core2.getInput("pr-skip-user-regexp", { required: false })
    };
  }
});

// src/trello/trello_connector.js
var require_trello_connector = __commonJS({
  "src/trello/trello_connector.js"(exports, module2) {
    ...
    module2.exports = class JiraConnector {
...
// src/github/github_connector.js
var require_github_connector = __commonJS({
  "src/github/github_connector.js"(exports, module2) {
    var github2 = require_github();
    var { GITHUB_TOKEN } = require_input();
    var GithubConnector2 = class {
      constructor() {
        this.octokit = new github2.getOctokit(GITHUB_TOKEN);
      }
      async updatePR(title, body) {
        const data = {
          owner: github2.context.payload.repository.owner.login,
          repo: github2.context.payload.repository.name,
    ...
    module2.exports = GithubConnector2;
  }
});
...
var require_utils5 = __commonJS({
  "src/utils.js"(exports, module2) {
    var util = require("util");
    var github2 = require_github();
    var HIDDEN_MARKER_START = "<!--action-trello-integration-start-->";
    var HIDDEN_MARKER_END = "<!--action-trello-integration-end-->";
    var WARNING_MESSAGE_ABOUT_HIDDEN_MARKERS = "<!--do not remove this marker, needed for action-trello-integration-->";
    var escapeRegexp = (str) => str.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    var getPrTitle2 = (card) => {
      return `[${card.shortLink}] ${card.name}`;
    };
    var getPrDescription2 = (oldBody, trelloCard, trelloCardAttachments, trelloCardChecklists) => {
...
`.trim();
    ...
    var buildPrDescription = (card, trelloCardAttachments, trelloCardChecklists) => {
...
`.trim();
    ...
    var buildChecklistsMarkdown = (trelloCardChecklists) => {
...
${checklists}`;
    ...
    var buildAttachmentsMarkdown = (trelloCardAttachments) => {
      const pull_request = github2.context.payload.pull_request;
      const attachments = trelloCardAttachments.filter((attachment) => {
...
${attachments}`;
    ...
    module2.exports = {
      ...
      escapeRegexp,
      getPrTitle: getPrTitle2,
      getPrDescription: getPrDescription2
    };
  }
});
...
var { get, isArray } = require_lodash();
var TrelloConnector = require_trello_connector();
...
async function run() {
  ...
  const eliteAuthor = PR_SKIP_USER_REGEXP && pull_request.user.login.match(new RegExp(PR_SKIP_USER_REGEXP));
  if (eliteAuthor) {
    core.info('Will not fail under any circumstances as author matches "pr-skip-user-regexp"');
  ...
  if (!cardCode) {
    if (PR_ENFORCE_CARD_EXISTS && !eliteAuthor) {
  ...
  if (TRELLO_BOARD_ID && trelloCard.idBoard !== TRELLO_BOARD_ID) {
    core.setFailed(`Trello card board ID ${trelloCard.idBoard} not the same as provided "trello-board-id" (${TRELLO_BOARD_ID})`);
    return;
  }
